...
import '/index.dart';
import 'upload_products_widget.dart' show UploadProductsWidget;
import 'package:flutter/material.dart';

class UploadProductsModel extends FlutterFlowModel<UploadProductsWidget> {
  ...
  bool? switchValue;
  // Stores action output result for [AI Agent - Send Message to Anna Bazaar Product Assistant] action in Switch widget.
  Map<String, dynamic>? generatedProductDetails;
