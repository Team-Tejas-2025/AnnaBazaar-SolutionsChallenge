...
class BuyerProfileWidget extends StatefulWidget {
  ...
  static String routeName = 'Buyer_Profile';
  static String routePath = '/buyerProfile';
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'ha6cm4zg' /* buyer.annabazaar@gmail.com */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.network(
                                                    'https://images.unsplash.com/photo-1458917524587-d3236cc8c2c8?w=500&h=500',
                                                    width: 60.0,
                                                    height: 60.0,
                                                    fit: BoxFit.cover,
                                                  ),
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'm0ixrky5' /* Fresh Vegetables Bundle */,
                                                      ),
                                                    ...
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'al6ah3bp' /* ₹450 • Delivered on May 15 */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.network(
                                                    'https://images.unsplash.com/photo-1517282009859-f000ec3b26fe?w=500&h=500',
                                                    width: 60.0,
                                                    height: 60.0,
                                                    fit: BoxFit.cover,
                                                  ),
